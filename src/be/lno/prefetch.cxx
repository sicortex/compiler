...
#ifdef TARG_MIPS
  // Bug 13482: Hardware supports prefetch in a conservative way.
  if (Is_Target_Mips5kf())   return 1;
  if (Is_Target_twc9a ())    return 2; //CONSERVATIVE_PREFETCH, more aggressive
#endif
#ifdef TARG_IA64
  if (Is_Target_Itanium()) return 2; // more aggressive
#endif
#ifdef TARG_X8664
  if (Is_Target_Orochi()||Is_Target_Sandy_Bridge()) return NO_PREFETCH;
