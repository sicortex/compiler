...
ISA_PRINT_TYPE oindex64_uimm8_simm32_int32 = ISA_Print_Type_Create("oindex64_uimm8_simm32_int32",
"%s %s ,%s%s(,%s,%s) ");
Name();
Operand(0);
Segment();
...
Operand(1);
Operand(2);
	Instruction_Print_Group(oindex64_uimm8_simm32_int32,
		TOP_vmovd_i32_oindex64_uimm8_simm32_int32,
		TOP_UNDEFINED);


ISA_PRINT_TYPE on32_int64 = ISA_Print_Type_Create("on32_int64",
"%s %s ,%s");
Name();
Operand(0);
Operand(1);
	Instruction_Print_Group(on32_int64,
		TOP_vmovq_i64_on32_int64,
		TOP_UNDEFINED);


ISA_PRINT_TYPE oint32rflag_float_base64_simm32 = ISA_Print_Type_Create("oint32rflag_float_base64_simm32",
"%s %s%s(%s) ,%s ");
Name();
Segment();
Operand(2);
Operand(1);
Operand(0);
	Instruction_Print_Group(oint32rflag_float_base64_simm32,
...
ISA_PRINT_TYPE obase64_offset_index64_uimm8_int32 = ISA_Print_Type_Create("obase64_offset_index64_uimm8_int32",
"%s %s ,%s%s(%s,%s,%s) ");
Name();
Operand(0);
Segment();
...
Operand(3);
Operand(4);
	Instruction_Print_Group(obase64_offset_index64_uimm8_int32,
...
ISA_PRINT_TYPE oint32rflag_float_float = ISA_Print_Type_Create("oint32rflag_float_float",
"%s %s ,%s ");
Name();
Operand(1);
Operand(0);
	Instruction_Print_Group(oint32rflag_float_float,
...
ISA_PRINT_TYPE oint32_n32 = ISA_Print_Type_Create("oint32_n32",
"%s %s ,%s");
Name();
Operand(0);
Result(0);
	Instruction_Print_Group(oint32_n32,
...
ISA_PRINT_TYPE oint64_base64_simm32_index64_uimm8 = ISA_Print_Type_Create("oint64_base64_simm32_index64_uimm8",
"%s %s%s(%s,%s,%s) ,%s");
Name();
Segment();
Operand(1);
...
Operand(3);
Result(0);
	Instruction_Print_Group(oint64_base64_simm32_index64_uimm8,
		TOP_vmovq_i64_oint64_base64_simm32_index64_uimm8,
		TOP_UNDEFINED);


ISA_PRINT_TYPE mxcsr_index64_uimm8_simm32 = ISA_Print_Type_Create("mxcsr_index64_uimm8_simm32",
"%s %s%s(,%s,%s) ");
Name();
Segment();
Operand(3);
Operand(1);
Operand(2);
	Instruction_Print_Group(mxcsr_index64_uimm8_simm32,
...
ISA_PRINT_TYPE oindex64_uimm8_simm32_int64 = ISA_Print_Type_Create("oindex64_uimm8_simm32_int64",
"%s %s ,%s%s(,%s,%s) ");
Name();
Operand(0);
Segment();
...
Operand(1);
Operand(2);
	Instruction_Print_Group(oindex64_uimm8_simm32_int64,
...
ISA_PRINT_TYPE oint32rflag_float_index64_uimm8_simm32 = ISA_Print_Type_Create("oint32rflag_float_index64_uimm8_simm32",
"%s %s%s(,%s,%s) ,%s ");
Name();
Segment();
Operand(3);
...
Operand(2);
Operand(0);
	Instruction_Print_Group(oint32rflag_float_index64_uimm8_simm32,
...
ISA_PRINT_TYPE obase64_offset_index64_uimm8_mxcsr = ISA_Print_Type_Create("obase64_offset_index64_uimm8_mxcsr",
"%s ,%s%s(%s,%s,%s) ");
Name();
Segment();
Operand(2);
...
Operand(3);
Operand(4);
	Instruction_Print_Group(obase64_offset_index64_uimm8_mxcsr,
...
ISA_PRINT_TYPE oint64_n32 = ISA_Print_Type_Create("oint64_n32",
"%s %s ,%s");
Name();
Operand(0);
Result(0);
	Instruction_Print_Group(oint64_n32,
...
ISA_PRINT_TYPE on32_mxcsr = ISA_Print_Type_Create("on32_mxcsr",
"%s ,%s");
Name();
Operand(1);
	Instruction_Print_Group(on32_mxcsr,
		TOP_vstmxcsr_on32_mxcsr,
		TOP_UNDEFINED);


ISA_PRINT_TYPE on32_int32 = ISA_Print_Type_Create("on32_int32",
"%s %s ,%s");
Name();
Operand(0);
Operand(1);
	Instruction_Print_Group(on32_int32,
...
ISA_PRINT_TYPE obase64_simm32_int32 = ISA_Print_Type_Create("obase64_simm32_int32",
"%s %s ,%s%s(%s) ");
Name();
Operand(0);
Segment();
Operand(2);
Operand(1);
	Instruction_Print_Group(obase64_simm32_int32,
...
ISA_PRINT_TYPE obase64_offset_index64_uimm8_float = ISA_Print_Type_Create("obase64_offset_index64_uimm8_float",
"%s %s ,%s%s(%s,%s,%s) ");
Name();
Operand(0);
Segment();
...
Operand(3);
Operand(4);
	Instruction_Print_Group(obase64_offset_index64_uimm8_float,
...
ISA_PRINT_TYPE mxcsr_n32 = ISA_Print_Type_Create("mxcsr_n32",
"%s %s ");
Name();
Operand(0);
	Instruction_Print_Group(mxcsr_n32,
...
ISA_PRINT_TYPE ofloat_base64_simm32_index64_uimm8 = ISA_Print_Type_Create("ofloat_base64_simm32_index64_uimm8",
"%s %s%s(%s,%s,%s) ,%s");
Name();
Segment();
Operand(1);
...
Operand(3);
Result(0);
	Instruction_Print_Group(ofloat_base64_simm32_index64_uimm8,
...
ISA_PRINT_TYPE obase64_simm32_int64 = ISA_Print_Type_Create("obase64_simm32_int64",
"%s %s ,%s%s(%s) ");
Name();
Operand(0);
Segment();
Operand(2);
Operand(1);
	Instruction_Print_Group(obase64_simm32_int64,
		TOP_vmovq_i64_obase64_simm32_int64,
		TOP_UNDEFINED);


ISA_PRINT_TYPE oint32_base64_simm32_index64_uimm8 = ISA_Print_Type_Create("oint32_base64_simm32_index64_uimm8",
"%s %s%s(%s,%s,%s) ,%s");
Name();
Segment();
Operand(1);
...
Operand(3);
Result(0);
	Instruction_Print_Group(oint32_base64_simm32_index64_uimm8,
...
ISA_PRINT_TYPE obase64_offset_index64_uimm8_int64 = ISA_Print_Type_Create("obase64_offset_index64_uimm8_int64",
"%s %s ,%s%s(%s,%s,%s) ");
Name();
Operand(0);
Segment();
...
Operand(3);
Operand(4);
	Instruction_Print_Group(obase64_offset_index64_uimm8_int64,
...
Result(0);
	Instruction_Print_Group(ofloat_float_simm8,
		...
		TOP_vpslldq_f128_ofloat_float_simm8,
		TOP_vpsrldq_f128_ofloat_float_simm8,
		TOP_vpsllw_f128_ofloat_float_simm8,
		TOP_vpsrad_f128_ofloat_float_simm8,
		TOP_vpsrlw_f128_ofloat_float_simm8,
		TOP_vpsrlq_f128_ofloat_float_simm8,
		TOP_UNDEFINED);
...
ISA_PRINT_TYPE oint32rflag_float_base64_index64_uimm8_simm32 = ISA_Print_Type_Create("oint32rflag_float_base64_index64_uimm8_simm32",
"%s %s%s(%s,%s,%s) ,%s ");
Name();
Segment();
Operand(4);
...
Operand(3);
Operand(0);
	Instruction_Print_Group(oint32rflag_float_base64_index64_uimm8_simm32,
...
ISA_PRINT_TYPE mxcsr_base64_simm32_index64_uimm8 = ISA_Print_Type_Create("mxcsr_base64_simm32_index64_uimm8",
"%s %s%s(%s,%s,%s) ");
Name();
Segment();
Operand(2);
...
Operand(3);
Operand(4);
	Instruction_Print_Group(mxcsr_base64_simm32_index64_uimm8,
...
ISA_PRINT_TYPE ofloat_n32 = ISA_Print_Type_Create("ofloat_n32",
"%s %s ,%s");
Name();
Operand(0);
Result(0);
	Instruction_Print_Group(ofloat_n32,
...
ISA_PRINT_TYPE mxcsr_base64_simm32 = ISA_Print_Type_Create("mxcsr_base64_simm32",
"%s %s%s(%s) ");
Name();
Segment();
Operand(2);
Operand(1);
	Instruction_Print_Group(mxcsr_base64_simm32,
		TOP_vldmxcsr_mxcsr_base64_simm32,
		TOP_UNDEFINED);
...
ISA_PRINT_TYPE on32_float = ISA_Print_Type_Create("on32_float",
"%s %s ,%s");
Name();
Operand(0);
Operand(1);
	Instruction_Print_Group(on32_float,
