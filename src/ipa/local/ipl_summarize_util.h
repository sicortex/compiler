...
// -----------------------------------------------------------------
//
// KEY: Bug 14679 requires the definition of ptr_hash to be inside a
// named namespace, or in the global namespace.

namespace ipa_util /* KEY bug 14679 */ {
    template <class X>
    struct ptr_hash {
...
typedef hash_map<CODEREP*, INT, ipa_util::ptr_hash<CODEREP>, std::equal_to<CODEREP*>,
...
typedef hash_map<PHI_NODE*, INT, ipa_util::ptr_hash<PHI_NODE>, std::equal_to<PHI_NODE*>,
