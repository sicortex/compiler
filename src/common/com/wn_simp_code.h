/*
 * Copyright 2008 (C) PathScale, LLC.  All Rights Reserved.
 */
...
static BOOL is_floating_equal(simpnode k, double d)
{
   ...
   switch (ty) {
    ...
    case MTYPE_F16:
      /* Tricky: we must convert d to a quad */
      dval = Host_To_Targ_Float(MTYPE_F16, d);
      eqval = Targ_To_Host(Targ_WhirlOp(OPC_I4F16EQ,dval,kval,NULL));
      return (eqval != 0);
   }
   return (FALSE);
}
 ...
 */
#define B(t) (1<<t)
#define PRECISE_I1 B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_I1)|B(MTYPE_I2)|B(MTYPE_I4)|B(MTYPE_I8)
#define PRECISE_I2 B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_I2)|B(MTYPE_I4)|B(MTYPE_I8)
#define PRECISE_I4 B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_I4)|B(MTYPE_I8)
#define PRECISE_I8 B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_I8)
#define PRECISE_U1 B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_U1)|B(MTYPE_U2)|B(MTYPE_U4)|B(MTYPE_U8)
#define PRECISE_U2 B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_U2)|B(MTYPE_U4)|B(MTYPE_U8)
#define PRECISE_U4 B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)|B(MTYPE_I8)
#define PRECISE_U8 B(MTYPE_FQ)|B(MTYPE_F16)
#define PRECISE_F4 B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)
#define PRECISE_F8 B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16)
#define PRECISE_FQ B(MTYPE_FQ)|B(MTYPE_F16)
#define PRECISE_F16 B(MTYPE_F16)
#define TESTABLE_TYPE (B(MTYPE_U1)|B(MTYPE_U2)|B(MTYPE_U4)|B(MTYPE_U8)|\
		       B(MTYPE_I1)|B(MTYPE_I2)|B(MTYPE_I4)|B(MTYPE_I8)|\
		       B(MTYPE_F4)|B(MTYPE_F8)|B(MTYPE_FQ)|B(MTYPE_F16))
   ...
   if (k1const && SIMP_IS_TYPE_INTEGRAL(ty)) {
	 ...
	 if (SIMP_Is_Int_Constant(SIMPNODE_kid1(k0))) /* KEY */{
	    ...
	    if (is_sub_ok(&c3,c2,c1,ty)) {
		 ...
		 SIMP_Is_Int_Constant(SIMPNODE_kid1(k0)) && // KEY
		 /* 15195: Check for moving an unsigned MPY through a relop */
		 (! SIMP_IS_TYPE_UNSIGNED(SIMPNODE_rtype(k0)) ||
		  Simp_Fold_Unsigned_Relops) && Simp_Unsafe_Relops) {
	 /*
...
#ifdef KEY // bug 14915: I4CVTL 16 (I4I2LDID): delete the CVTL
   } else if (OPCODE_is_load(SIMPNODE_opcode(k0)) &&
      	      !(SIMPNODE_operator(k0) == OPR_LDID && ST_class(SIMPNODE_st(k0)) == CLASS_PREG /* bug 14951 */) &&
	      OPCODE_rtype(SIMPNODE_opcode(k0)) == dest_ty &&
	      SIMP_TYPE_SIZE(OPCODE_desc(SIMPNODE_opcode(k0))) == cvtl_bits) {
       r = k0;
#endif
   } else {
