...
#  endif /* KEY Bug 4210 */
#  ifdef KEY /* Bug 5545 */
   /* Append /usr/local/include and /usr/include to include-search-path list,
    * so that ftpp behaves like cpp */
   add_to_fp_table("/usr/local/include", &include_path_idx, 'I');
...
#ifdef KEY /* Sicortex bug 6836 */
   /* Append /usr/local/include and /usr/include to module-search-path list
    * following "./" (Sicortex bug 6836.) Do so by imitating -p option. */
   add_to_fp_table("/usr/local/include", &module_path_idx, 'p');
   add_to_fp_table("/usr/include", &module_path_idx, 'p');
#endif /* KEY Sicortex bug 6836 */
