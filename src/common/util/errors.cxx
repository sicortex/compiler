...
#ifdef KEY
	    Fatal_Error ("I/O error while compiling %s: %s",
			 Orig_Src_File_Name ? Orig_Src_File_Name :
			 Src_File_Name,
			 strerror(error_num));
#else
