...
ix86_builtins2gsbi_ts (enum ix86_builtins code) 
{
  switch (code) {
	...
	case IX86_BUILTIN_SETREPI32: return GSBI_IX86_BUILTIN_SETREPI32;
	case IX86_BUILTIN_SETREPI16: return GSBI_IX86_BUILTIN_SETREPI16;
	case IX86_BUILTIN_SETREPI8: return GSBI_IX86_BUILTIN_SETREPI8;
    ...
    case IX86_BUILTIN_PHSUBSW: return GSBI_IX86_BUILTIN_PHSUBSW;
	  ...
	  case IX86_BUILTIN_PALIGNR: return GSBI_IX86_BUILTIN_PALIGNR;
		...
		case IX86_BUILTIN_AESDEC: return GSBI_IX86_BUILTIN_AESDEC;
	    case IX86_BUILTIN_AESENC: return GSBI_IX86_BUILTIN_AESENC;
		case IX86_BUILTIN_AESDECLAST:return GSBI_IX86_BUILTIN_AESDECLAST;
	    case IX86_BUILTIN_AESENCLAST:return GSBI_IX86_BUILTIN_AESENCLAST;
	    case IX86_BUILTIN_AESIMC: return GSBI_IX86_BUILTIN_AESIMC;
	    case IX86_BUILTIN_AESKEYGENASSIST: return GSBI_IX86_BUILTIN_AESKEYGENASSIST;
	    case IX86_BUILTIN_PCLMULDQD: return GSBI_IX86_BUILTIN_PCLMULDQD;
		/*AVX ISA*/
#include "tree_avx.c"
...
gs_x_1 (tree t, HOST_WIDE_INT seq_num)
{
  ...
  switch (TREE_CODE_CLASS (TREE_CODE (t)))
	...
	if (TREE_CODE (t) == VAR_DECL || TREE_CODE (t) == FUNCTION_DECL)
	  ...
	  switch (TREE_CODE(t)) {
	    case FUNCTION_DECL:
	      if (DECL_LANG_SPECIFIC(t)) { // sicortex 7296
