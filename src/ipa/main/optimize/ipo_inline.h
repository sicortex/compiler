...
#define HEADER_FILE_INVALID_OFST -1
typedef INT16 OFST_TYPE;
// matrix for holding DST header file adjustment offsets among files
extern OFST_TYPE ** Header_File_Offsets;
