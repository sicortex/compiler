...
ISA_PRINT_TYPE mxcsr_base64_index64_uimm8_simm32 = ISA_Print_Type_Create("mxcsr_base64_index64_uimm8_simm32",
"%s %s%s(%s,%s,%s) ");
Name();
Segment();
Operand(4);
...
Operand(2);
Operand(3);
	Instruction_Print_Group(mxcsr_base64_index64_uimm8_simm32,
