...
case O_subverbose:
	subverbose=1;
	break;
case O_stl_not_threadsafe:
	stl_threadsafe=FALSE;
	break;
case O_stdinc:
	nostdinc=FALSE;
	break;
...
case O_cord:
	...
	break;
case O_copyright:
	{show_copyright = TRUE; execute_flag = FALSE;}
	break;
case O_convert:
...
case O_64:
	...
	break;
case O__sysrootQ__:
	set_sysroot(optargs,0);
	break;
case O__sysroot_n32Q__:
	set_sysroot(optargs,-1);
	break;
case O__sysroot_64Q__:
	set_sysroot(optargs,1);
	break;
case O__:
	check_dashdash();
...
case O_w:
	...
	break;
case O_static:
	if (shared != NON_SHARED) return TRUE;
	break;
case O_shared:
...
case O_mno_sse4a:
	...
	break;
case O_mno_sse4_2:
	if (sse4_2 != FALSE) return TRUE;
	break;
case O_mno_sse4_1:
	if (sse4_1 != FALSE) return TRUE;
	break;
case O_mno_sse3:
...
case O_mno_3dnow:
	...
	break;
case O_mips64:
	if (isa != ISA_MIPS64) return TRUE;
	break;
case O_mips4:
	if (isa != ISA_MIPS4) return TRUE;
	break;
case O_mips3:
	if (isa != ISA_MIPS3) return TRUE;
	break;
case O_mips2:
	if (isa != ISA_MIPS2) return TRUE;
	break;
case O_mips1:
	if (isa != ISA_MIPS1) return TRUE;
	break;
case O_m3dnow:
...
case O_fpic:
	...
	break;
case O_fno_pic:
	if (pic != FALSE) return TRUE;
	break;
case O_fno_math_errno:
	if (fmath_errno != 0) return TRUE;
	break;
case O_fno_gnu_exceptions:
	if (gnu_exceptions != FALSE) return TRUE;
	break;
case O_fno_fast_math:
...
case O_fixedform:
	...
	break;
case O_fgnu_exceptions:
	if (gnu_exceptions != TRUE) return TRUE;
	break;
case O_ffast_math:
...
case O_G__:
	...
	break;
case O_EL:
	if (endian != ENDIAN_LITTLE) return TRUE;
	break;
case O_EB:
	if (endian != ENDIAN_BIG) return TRUE;
	break;
case O_64:
	if (abi != ABI_64) return TRUE;
	break;
