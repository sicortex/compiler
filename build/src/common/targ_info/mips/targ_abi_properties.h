...
typedef struct {
  mUINT16 reg_flags[5][32];
  const char *reg_names[5][32];
} ABI_PROPERTIES;

#define ABI_PROPERTY_allocatable          0x0001
#define ABI_PROPERTY_callee               0x0002
#define ABI_PROPERTY_caller               0x0004
#define ABI_PROPERTY_func_arg             0x0008
#define ABI_PROPERTY_func_val             0x0010
#define ABI_PROPERTY_stack_ptr            0x0100
#define ABI_PROPERTY_frame_ptr            0x0200
#define ABI_PROPERTY_static_link          0x0020
#define ABI_PROPERTY_global_ptr           0x0040
#define ABI_PROPERTY_entry_ptr            0x0080
#define ABI_PROPERTY_zero                 0x0800
#define ABI_PROPERTY_ret_addr             0x0400
