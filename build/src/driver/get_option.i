...
case 'u':
	...
	if (strcmp(argv[*argi],"-useacml_mv") == 0) {
		get_next_arg(argi);
		return O_useacml_mv;
		/* NOTREACHED */
	}
...
case 's':
	...
	if (strcmp(argv[*argi],"-stl_not_threadsafe") == 0) {
		get_next_arg(argi);
		return O_stl_not_threadsafe;
		/* NOTREACHED */
	}
...
case 'r':
	...
	if (strcmp(argv[*argi],"-r5000") == 0) {
		get_next_arg(argi);
		return O_r5000;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-r4000") == 0) {
		get_next_arg(argi);
		return O_r4000;
		/* NOTREACHED */
	}
...
case 'n':
	...
	if (strcmp(argv[*argi],"-nolibpscrt") == 0) {
		get_next_arg(argi);
		return O_nolibpscrt;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-nog77mangle") == 0) {
		get_next_arg(argi);
		return O_nog77mangle;
		/* NOTREACHED */
	}
...
case 'm':
	...
	if (strcmp(argv[*argi],"-msse4_2") == 0) {
		get_next_arg(argi);
		return O_msse4_2;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-msse4_1") == 0) {
		get_next_arg(argi);
		return O_msse4_1;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-mno-sse4_2") == 0) {
		get_next_arg(argi);
		return O_mno_sse4_2;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-mno-sse4_1") == 0) {
		get_next_arg(argi);
		return O_mno_sse4_1;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-mno-memcpy") == 0) {
		get_next_arg(argi);
		return O_mno_memcpy;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-mmemcpy") == 0) {
		get_next_arg(argi);
		return O_mmemcpy;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-mips64") == 0) {
		get_next_arg(argi);
		return O_mips64;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-mips3") == 0) {
		get_next_arg(argi);
		return O_mips3;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-mips2") == 0) {
		get_next_arg(argi);
		return O_mips2;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-mips1") == 0) {
		get_next_arg(argi);
		return O_mips1;
		/* NOTREACHED */
	}
...
case 'f':
	...
	if (strcmp(argv[*argi],"-fstrict-stl") == 0) {
		get_next_arg(argi);
		return O_fstrict_stl;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-fstrict-overflow") == 0) {
		get_next_arg(argi);
		return O_fstrict_overflow;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fpsclang") == 0) {
		get_next_arg(argi);
		return O_fpsclang;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fomp_trace") == 0) {
		get_next_arg(argi);
		return O_fomp_trace;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fno-strict-overflow") == 0) {
		get_next_arg(argi);
		return O_fno_strict_overflow;
		/* NOTREACHED */
	}
	...
	if (!is_new_arg) break;
	if (strncmp(argv[*argi],"-fno-builtin-",13) == 0) {
		end_option(argv, argi, 13);
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_string_option(O_fno_builtin_,optargs);
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fno-asynchronous-unwind-tables") == 0) {
		get_next_arg(argi);
		return O_fno_asynchronous_unwind_tables;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fgnu89-inline") == 0) {
		get_next_arg(argi);
		return O_fgnu89_inline;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-feliminate-unused-debug-types") == 0) {
		get_next_arg(argi);
		return O_feliminate_unused_debug_types;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fbootstrap-hack") == 0) {
		get_next_arg(argi);
		return O_fbootstrap_hack;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-fasynchronous-unwind-tables") == 0) {
		get_next_arg(argi);
		return O_fasynchronous_unwind_tables;
		/* NOTREACHED */
	}
...
case 'W':
	...
	if (strcmp(argv[*argi],"-Wno-nonnull") == 0) {
		get_next_arg(argi);
		return O_Wno_nonnull;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-Wno-address") == 0) {
		get_next_arg(argi);
		return O_Wno_address;
		/* NOTREACHED */
	}
	...
	if (strcmp(argv[*argi],"-Waddress") == 0) {
		get_next_arg(argi);
		return O_Waddress;
		/* NOTREACHED */
	}
	...
	if (strncmp(argv[*argi],"-Wa,",4) == 0) {
		...
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_string_option(O_WaC,optargs);
		/* NOTREACHED */
	}
	if (!is_new_arg) break;
...
case 'R':
	...
	if (want_directory(next_string(argv,argi))) {
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_any_string_option(O_R__,optargs);
		/* NOTREACHED */
	} else if (!is_last_char(argv,argi)) {
		if (fullwarn) {
			warning("%s does not refer to a valid directory", option_name);
...
case 'F':
	...
	break;
case 'E':
	if (strcmp(argv[*argi],"-EL") == 0) {
		get_next_arg(argi);
		return O_EL;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"-EB") == 0) {
		get_next_arg(argi);
		return O_EB;
		/* NOTREACHED */
	}
...
case '-':
	...
	if (strcmp(argv[*argi],"--traditional-p") == 0) {
		get_next_arg(argi);
		return O__traditional_p;
		/* NOTREACHED */
	}
	if (strcmp(argv[*argi],"--traditional") == 0) {
		get_next_arg(argi);
	...
	if (!is_new_arg) break;
	if (strncmp(argv[*argi],"--sysroot=",10) == 0) {
		end_option(argv, argi, 10);
	if (want_directory(next_string(argv,argi))) {
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_any_string_option(O__sysrootQ__,optargs);
		/* NOTREACHED */
	} else if (!is_last_char(argv,argi)) {
		if (fullwarn) {
			warning("%s does not refer to a valid directory", option_name);
	...
	if (!is_new_arg) break;
	if (strncmp(argv[*argi],"--sysroot-n32=",14) == 0) {
		end_option(argv, argi, 14);
	if (want_directory(next_string(argv,argi))) {
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_any_string_option(O__sysroot_n32Q__,optargs);
		/* NOTREACHED */
	} else if (!is_last_char(argv,argi)) {
		if (fullwarn) {
			warning("%s does not refer to a valid directory", option_name);
	...
	if (!is_new_arg) break;
	if (strncmp(argv[*argi],"--sysroot-64=",13) == 0) {
		end_option(argv, argi, 13);
	if (want_directory(next_string(argv,argi))) {
		optargs = get_optarg(argv, argi);
		get_next_arg(argi);
		return add_any_string_option(O__sysroot_64Q__,optargs);
		/* NOTREACHED */
	} else if (!is_last_char(argv,argi)) {
		if (fullwarn) {
			warning("%s does not refer to a valid directory", option_name);
...
get_real_option_if_aliased(int flag)
{
  switch (flag) {
	...
	case O_mmmx: return O_mmmx;
	case O_jalr: {
		optargs = "force_jalr";
		return add_string_option(O_TARG_,optargs);
		}
	case O_funwind_tables: {
		optargs = "emit_unwind_info=on";
		return add_string_option(O_CG_,optargs);
		}
	...
	case O__traditional_p: return O_traditional_cpp;
