...
#define PROP_move             0x1ULL
#define PROP_load             0x2ULL
#define PROP_store            0x4ULL
#define PROP_fp_load          0x8ULL
#define PROP_fp_store         0x10ULL
#define PROP_prefetch         0x20ULL
#define PROP_xfer             0x40ULL
#define PROP_call             0x80ULL
#define PROP_cond             0x100ULL
#define PROP_cond_move        0x200ULL
#define PROP_fp_move          0x400ULL
#define PROP_uniq_res         0x800ULL
#define PROP_same_res         0x1000ULL
#define PROP_unalign_ld       0x2000ULL
#define PROP_unalign_store    0x4000ULL
#define PROP_iadd             0x8000ULL
#define PROP_isub             0x10000ULL
#define PROP_imul             0x20000ULL
#define PROP_idiv             0x40000ULL
#define PROP_iop64            0x80000ULL
#define PROP_flop             0x100000ULL
#define PROP_fadd             0x200000ULL
#define PROP_fsub             0x400000ULL
#define PROP_fmul             0x800000ULL
#define PROP_fmisc            0x1000000ULL
#define PROP_madd             0x2000000ULL
#define PROP_noop             0x4000000ULL
#define PROP_dummy            0x8000000ULL
#define PROP_itrap            0x10000000ULL
#define PROP_unsafe           0x20000000ULL
#define PROP_fdiv             0x40000000ULL
#define PROP_sqrt             0x80000000ULL
#define PROP_memtrap          0x100000000ULL
#define PROP_defs_fcc         0x200000000ULL
#define PROP_defs_fcr         0x400000000ULL
#define PROP_refs_fcr         0x800000000ULL
...
#define PROP_side_effects     0x80000000000ULL
#define PROP_var_opnds        0x100000000000ULL
#define PROP_fp_arith         0x200000000000ULL
#define PROP_fp_unpredictable_latency 0x400000000000ULL
#define PROP_fp_stall_hazard  0x800000000000ULL
#define PROP_fp_round_hazard  0x1000000000000ULL
#define PROP_fp_round_trigger 0x2000000000000ULL
...
#define TOP_is_fp_load(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_load)
#define TOP_is_fp_store(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_store)
...
#define TOP_is_fp_move(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_move)
...
#define TOP_is_unknown_memdata(t)	 (FALSE)
#define TOP_is_unknown_addr(t)	 (FALSE)
...
#define TOP_is_iop64(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_iop64)
...
#define TOP_is_itrap(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_itrap)
...
#define TOP_is_defs_fcc(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_defs_fcc)
#define TOP_is_defs_fcr(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_defs_fcr)
#define TOP_is_refs_fcr(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_refs_fcr)
...
#define TOP_is_fp_arith(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_arith)
#define TOP_is_fp_unpredictable_latency(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_unpredictable_latency)
#define TOP_is_fp_stall_hazard(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_stall_hazard)
#define TOP_is_fp_round_hazard(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_round_hazard)
#define TOP_is_fp_round_trigger(t)	 (ISA_PROPERTIES_flags[(INT)t] & PROP_fp_round_trigger)
