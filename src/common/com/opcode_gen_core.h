...
typedef enum {
...
#endif /* TARG_X8664 */
  OPC_I4MADD             = OPR_MADD + RTYPE(MTYPE_F4) + DESC(MTYPE_V),
  ...
  OPC_V16I4MADD          = OPR_MADD + RTYPE(MTYPE_V16I4)  + DESC(MTYPE_V),
  OPC_V16F4MADD          = OPR_MADD + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V16F8MADD          = OPR_MADD + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
  OPC_V32F4MADD          = OPR_MADD + RTYPE(MTYPE_V32F4) + DESC(MTYPE_V),
  OPC_V32F8MADD          = OPR_MADD + RTYPE(MTYPE_V32F8) + DESC(MTYPE_V),
#ifdef TARG_MIPS
  ...
  OPC_V32F8MAX           = OPR_MIN + RTYPE(MTYPE_V32F8) + DESC(MTYPE_V),
#endif /* TARG_X8664 */
  ...
  OPC_V16I4MSUB          = OPR_MSUB + RTYPE(MTYPE_V16I4)  + DESC(MTYPE_V),
  OPC_V16F4MSUB          = OPR_MSUB + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V16F8MSUB          = OPR_MSUB + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
  OPC_V32F4MSUB          = OPR_MSUB + RTYPE(MTYPE_V32F4) + DESC(MTYPE_V),
  OPC_V32F8MSUB          = OPR_MSUB + RTYPE(MTYPE_V32F8) + DESC(MTYPE_V),
#ifdef TARG_MIPS
  ...
  OPC_V16F4NMADD           = OPR_NMADD + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V16F8NMADD           = OPR_NMADD + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
  OPC_V32F4NMADD           = OPR_NMADD + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V32F8NMADD           = OPR_NMADD + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
#ifdef TARG_MIPS
  ...
  OPC_V16F4NMSUB           = OPR_NMSUB + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V16F8NMSUB           = OPR_NMSUB + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
  OPC_V32F4NMSUB           = OPR_NMSUB + RTYPE(MTYPE_V16F4) + DESC(MTYPE_V),
  OPC_V32F8NMSUB           = OPR_NMSUB + RTYPE(MTYPE_V16F8) + DESC(MTYPE_V),
#ifdef TARG_MIPS
  ...
  OPC_V32F4RECIP         = OPR_RECIP + RTYPE(MTYPE_V32F4) + DESC(MTYPE_V),
#endif /* TARG_X8664 */
  ...
  OPC_V32F4RSQRT         = OPR_RSQRT + RTYPE(MTYPE_V32F4) + DESC(MTYPE_V),
#endif /* TARG_X8664 */
  ...
  OPC_V32F4F4REPLICA     = OPR_REPLICATE + RTYPE(MTYPE_V32F4) + DESC(MTYPE_F4),
  OPC_V32F8F8REPLICA     = OPR_REPLICATE + RTYPE(MTYPE_V32F8) + DESC(MTYPE_F8),
  ...
  OPC_F4V32F4REDUCE_ADD = OPR_REDUCE_ADD+ RTYPE(MTYPE_F4) + DESC(MTYPE_V32F4),
  OPC_F8V32F8REDUCE_ADD = OPR_REDUCE_ADD+ RTYPE(MTYPE_F8) + DESC(MTYPE_V32F8),
  ...
  OPC_F4V32F4REDUCE_MPY = OPR_REDUCE_MPY+ RTYPE(MTYPE_F4) + DESC(MTYPE_V32F4),
  OPC_F8V32F8REDUCE_MPY = OPR_REDUCE_MPY+ RTYPE(MTYPE_F8) + DESC(MTYPE_V32F8),
  ...
  OPC_F4V32F4REDUCE_MAX = OPR_REDUCE_MAX+ RTYPE(MTYPE_F4) + DESC(MTYPE_V32F4),
  OPC_F8V32F8REDUCE_MAX = OPR_REDUCE_MAX+ RTYPE(MTYPE_F8) + DESC(MTYPE_V32F8),
  ...
  OPC_F4V32F4REDUCE_MIN = OPR_REDUCE_MIN+ RTYPE(MTYPE_F4) + DESC(MTYPE_V32F4),
  OPC_F8V32F8REDUCE_MIN = OPR_REDUCE_MIN+ RTYPE(MTYPE_F8) + DESC(MTYPE_V32F8),
  ...
  OPC_V32F4V32F4SHUFFLE = OPR_SHUFFLE + RTYPE(MTYPE_V32F4) + DESC(MTYPE_V32F4),
  OPC_V32F8V32F8SHUFFLE = OPR_SHUFFLE + RTYPE(MTYPE_V32F8) + DESC(MTYPE_V32F8),
