...
#ifdef KEY /* Bug 5091 */
/* Reuse "alt_darg" since "protected" is irrelevant for arguments */
# ifdef _DEBUG
#  define AT_PROTECTED(IDX)						       \
	((!AT_IS_DARG(IDX)) ?				       \
		attr_tbl : sytb_var_error("AT_PROTECTED", IDX))	       \
		[IDX].fld.alt_darg
# else
#  define AT_PROTECTED(IDX)		attr_tbl[IDX].fld.alt_darg
# endif
#endif /* KEY Bug 5091 */
